...
const Content_service=()=>{
    return(
        <Fragment>
            <div className="row row_services" style={{marginLeft:'1px',marginRight:'1px'}}>
                ...
                <div className="col-md-4">
                    <div className="services_content">
                        <i style={{color:'#9D4633', paddingTop:'50px'}} className="fas fa-book-open fa-3x" aria-hidden="true"></i>
